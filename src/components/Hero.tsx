...
export const Hero = () => {
  return (
    <section id="home" className="pt-16 bg-gradient-to-br from-green-50 to-emerald-50 overflow-hidden">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Empower your farming with cutting-edge technology. AgroMate provides intelligent solutions 
                for crop monitoring, soil analysis, and sustainable farming practices.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" size="lg" className="border-green-600 text-green-600 hover:bg-green-50 text-lg px-8 py-3">
                Watch Demo
              </Button>
            </div>
            ...
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8 lg:p-12">
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-semibold text-gray-900">Farm Dashboard</h3>
